...
<section class="dashboard">
   ...
   <div class="box">
      ...
      ?>
      <h3><?= $total_pendings; ?><span>Lei</span><span>/-</span></h3>
      <p>Comenzi nefinalizate</p>
      <a href="placed_orders.php" class="btn">vezi comenzi</a>
   </div>
   ...
   <div class="box">
      ...
      ?>
      <h3><?= $total_completes; ?><span>Lei</span><span>/-</span></h3>
   ...
   <div class="box">
      ...
      <p>produse</p>
      <a href="products.php" class="btn">vezi produse</a>
   </div>
